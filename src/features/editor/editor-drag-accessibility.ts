...
export const EDITOR_DRAG_ANNOUNCEMENTS = {
  onDragStart({ active }) {
    const asset = findDemoAssetFromDragData(active.data.current)
...
export function findDemoAssetFromDragData(value: unknown): DemoAsset | null {
